...
class Version20150518205909 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE testcase (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) NOT NULL, title VARCHAR(128) NOT NULL, cadence VARCHAR(4) NOT NULL, script CLOB NOT NULL, enabled BOOLEAN NOT NULL, created_at DATETIME NOT NULL, activated_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
